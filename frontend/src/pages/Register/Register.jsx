    ...
    <div className="auth-container">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="auth-card">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-slate-800">Get Started</h1>
          <p className="text-slate-400 font-bold mt-2">Join global student network</p>
        </div>

        <form className="space-y-6">
          <div className="relative">
             <input type="text" placeholder="Full Name" className="input-auth" />
             <User className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400" size={24} />
          </div>
          <div className="relative">
