...
import { Card, Badge, InputField } from '../../components/ui/premium/index'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 to-white px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Sign in to your account and continue your journey</p>
        </div>
        ...
        <Card className="p-6 mb-6">
          <form className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pl-10 rounded-lg border-2 border-slate-200 focus:border-primary-500 bg-white font-medium text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-100 transition-all duration-200"
                  value={password}
            ...
            {/* Submit */}
            <Button variant="primary" fullWidth size="lg" clasName="mt-6">
              Sign In
            </Button>
          </form>
        </Card>
